...
envsubst '${NGINX_LOG_PATH} ${NGINX_BUILT_FOLDER_PATH} ${NGINX_PORT}' < $NGINX_JEOPARDY_FOLDER/static-webserver.template.conf > $NGINX_JEOPARDY_FOLDER/static-webserver.conf
